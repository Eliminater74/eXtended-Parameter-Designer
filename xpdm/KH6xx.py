...
SpeedSwitchModeDesc = ["Switch", "Cycle 3", "High Switch", "Cycle 4"]

# LED indicator mode
IM_COMM_VCC = 0
IM_COMM_GND = 1

IndicatorModeDesc = ["Common VCC", "Common GND"]

# Slip charge mode
SCM_ENABLE = 0
SCM_DISABLE = 1

SlipChargeModeDesc = ["Enable", "Disable"]
...
EBSLevelDesc = ["Disabled", "Moderate", "Strong", "Unlimited"]
...
GuardLevelDesc = ["Low", "High"]

# Throttle blowout protect
TBP_DISABLE = 0
TBP_ENABLE = 1

ThrottleProtectDesc = ["Disabled", "Enabled"]

# Cruise limit
CruiseLimitDesc = ["No", "Yes"]

# Default speed
DefaultSpeedDesc = ["Speed 1", "Speed 2", "Speed 3", "Speed 4"]
...
""",
    ...
    "LowVoltageTolerance": {
        "Type": "f",
        "Name": "Battery low voltage threshold",
        "Description": """\
...
""",
    ...
    "LowVoltageCurrent": {
        "Type": "f",
        "Name": "Low voltage current limit",
        "Description": """\
...
""",
    ...
    "BlockTime": {
        "Type": "f",
        "Name": "Overcurrent detection delay",
        "Description": """\
...
infineon.RegisterFamily("KH6xx (Infineon 4)", Profile, DetectFormat4, infineon.CAP_DOWNLOAD,
                        ControllerModelDesc)
